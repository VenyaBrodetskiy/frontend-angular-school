...
const defaultOptions: ISelectableOption<string>[] = [
    {
        title: "option1",
        value: "opt1"
    },
...
const _defaultOptions2: ISelectableOption<number>[] = [
    {
        title: "option0",
        value: 1
    },
...
export class RadioButtonComponent {
    ...
    private _defaultOptions: ISelectableOption<string>[] = defaultOptions;
    private _defaultOptions2: ISelectableOption<number>[] = _defaultOptions2;
    private _defaultChecked: string = "opt2";
    private _defaultChecked2: number = 2;

    @Input() public name: string = "defaultRadioButton";
